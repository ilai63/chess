...
public class Queen extends Piece {
	...
	public Queen(Color color) { //Constructor
		super(color);
	}
	...
	public MoveType isValidMove(Position start, Position end, Board board, List<String[]> rawMoveList) {
	    ...
	    if (rowDiff == colDiff) { //Checks diagonals movements
	    ...
	    } else if (startRow == endRow || startCol == endCol) { //Checks straight movements
	...
	@Override
	public String getSymbol() {
		if (color == Color.BLACK) return "BQ";
		return "WQ";
	}
